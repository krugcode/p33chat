...
<div class="flex h-full w-full flex-col items-center justify-center overflow-y-auto">
	...
	<div class="flex max-w-xl flex-col items-center gap-2">
		...
		<div class="z-1 mt-5 w-full max-w-xl rounded-lg bg-gray-50 px-5 py-1">
	...
	<div class="z-1 mt-3 flex w-full max-w-xl flex-col gap-3 rounded-lg border bg-white p-5">
